...
class ResultBuilder:
    ...
    def __init__(self, kind: ResultType, orderid: int, client_order_id: Optional[str] = None):
        self._kind = kind
    ...
    @staticmethod
    def new_limit(orderid: int, client_order_id: str):
        '''Instantiate a new LIMIT result.'''
        return ResultBuilder(ResultType.LIMIT, orderid, client_order_id)

    @staticmethod
    def new_market(orderid: int, client_order_id: str):
        '''Instantiate a new MARKET result.'''
        return ResultBuilder(ResultType.MARKET, orderid, client_order_id)
    ...
    def set_client_order_id(self, client_order_id: str):
        self._client_order_id = client_order_id
...
class ExecutionResult:
    ...
    def __init__(self, result: ResultBuilder):
        ...
        self._client_order_id = result._client_order_id
